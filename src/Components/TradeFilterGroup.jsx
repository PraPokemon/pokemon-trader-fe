...
function TradeFilterGroup({ setSearchTerm,setMinLevel, setMaxLevel }) {
  const imagePaths = [
  ...
  return (
    <>
      ...
      <div className="FilterGroupOther">
        ...
        <div>
          <FilterLvL setMinLevel={setMinLevel} setMaxLevel={setMaxLevel} />
        </div>
...
export default TradeFilterGroup;
